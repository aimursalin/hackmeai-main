...
export function InteractiveNebulaShader({
  ...
  useEffect(() => {
    ...
    if (mat) {
      if (mat.uniforms.hasActiveReminders) mat.uniforms.hasActiveReminders.value   = hasActiveReminders;
      if (mat.uniforms.hasUpcomingReminders) mat.uniforms.hasUpcomingReminders.value = hasUpcomingReminders;
      if (mat.uniforms.disableCenterDimming) mat.uniforms.disableCenterDimming.value = disableCenterDimming;
    }
