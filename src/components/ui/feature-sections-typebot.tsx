...
const COLORS = {
  ...
  cardBackground: "#0c0516",
  cardBorder: "rgba(139, 92, 246, 0.1)", // Purple-500/10
  textPrimary: "#ffffff",
  textSecondary: "#a78bfa", // Purple-400
  marketingGradientStart: "#f59e0b", // Amber-500
  marketingGradientEnd: "#d97706", // Amber-600
  supportGradientStart: "#8b5cf6", // Purple-500
  supportGradientEnd: "#6d28d9", // Purple-700
  salesGradientStart: "#f59e0b",
  salesGradientEnd: "#d97706",
} as const;
