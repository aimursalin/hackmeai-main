  ...
  return (
    ...
    >
      <div className="relative">
        ...
        <motion.div
          className="absolute left-4 sm:left-6 top-0 w-px bg-accent origin-top"
          initial={{ scaleY: 0 }}
          whileInView={{ 
            scaleY: 1,
            transition: {
              ...
              >
                <div className="flex items-start gap-4 sm:gap-6">
                  <div className="relative flex-shrink-0">
                    ...
                    >
                      <div className="w-12 h-12 sm:w-16 sm:h-16 rounded-full overflow-hidden border-2 border-white/5 shadow-lg relative z-10 bg-background">
                        {item.image ? (
                          <img
                            src={item.image}
                  ...
                  >
                    <Card className={cn(
                      "border transition-all duration-300 hover:shadow-md relative bg-white/[0.02] backdrop-blur-md",
                      config.borderColor,
                      ...
                      <CardContent className="p-4 sm:p-6">
                        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-4 mb-3">
                          <div className="flex-1 min-w-0">
                            <motion.h3 
                              className="text-lg sm:text-xl font-semibold text-foreground mb-1 group-hover:text-accent transition-colors duration-300"
