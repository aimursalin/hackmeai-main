    ...
    <section id="pricing" className="py-32 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">Subscribe once, cancel anytime. No contracts, no friction.</p>
        </motion.div>
            ...
            >
              ...
              <div className="mb-8">
                <div className="flex items-baseline gap-1">
                  <span className="text-5xl font-bold text-foreground tabular-nums">${plan.price}</span>
